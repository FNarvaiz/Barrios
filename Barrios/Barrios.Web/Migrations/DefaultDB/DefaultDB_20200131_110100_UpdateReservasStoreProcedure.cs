...
{
    [Migration(20200131110100), Tags("Default")]
    public class DefaultDB_20200131_110100_UpdateReservasStoreProcedure : AutoReversingMigration
    {
        public override void Up()
        {
            ...
            query.Append("                        If @count < 2 ");// REVISA CUANTAS RESERVAS TIENE REALIZADAS
            query.Append("                        BEGIN ");
