...
{
    [Migration(20200124170100), Tags("Default")]
    public class DefaultDB_20200124_170100_UpdateReservasStoreProcedure : AutoReversingMigration
    {
                      ...
                      " BEGIN " +
                        ...
                        " BEGIN " +
                          ...
                          " BEGIN " +
                            ...
                            " If @OK = 1 " +
                              " INSERT INTO RESERVAS(BarrioId,ID_RECURSO, ID_VECINO, FECHA, INICIO, DURACION, ID_TIPO, ID_VECINO_2, DateInsert, UserInsert,observaciones) VALUES(@barrioId,@resourceId, @UserId, @date, @turnStart, @turnDuration, @turnTypeId, @extraNeighborId, GETDATE(), @UserId,@observaciones) " +
                             " END " +
                          " else " +
