...
{
    [Migration(20201027221200), Tags("Default")]
    public class DefaultDB_20201027_221200_UpdateReservasStoreProcedure : Migration
    {
        public override void Up()
        {
            ...
            query.Append("                          if @count = 1 and @admin =0 and 7 >@resourceType ");// REVISA QUE EL TURNO NO SE PISE CON OTRO TURNO Y NO SEA CONSECUTIVA CON OTRA
