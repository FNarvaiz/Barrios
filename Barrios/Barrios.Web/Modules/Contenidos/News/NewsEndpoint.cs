...
namespace Barrios.Contenidos.Endpoints
{
    ...
    using MyRepository = Repositories.NewsRepository;
    using MyRow = Entities.NewsRow;

    [RoutePrefix("Services/Contenidos/News"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class NewsController : ServiceEndpoint
    {
