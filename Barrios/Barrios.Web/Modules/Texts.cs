    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Barrios Password";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Barrios";
        }
        ...
        public static class Site
        {
            public static class AccessDenied
            {
                ...
                public static LocalText LackPermissions = "Usted ya tiene áctiva su cuenta pero aun no tiene los permisos para acceder.\n" +
                    "Comuniquese con el administrador de su barrio para autenticar su identidad y le otorguen los permisos.";
            ...
            public static class Locked
            {
                ...
                public static LocalText LackPermissions = "Esta sección esta temporalmente inhabilitada. Por favor comuniquese con la administración.";
