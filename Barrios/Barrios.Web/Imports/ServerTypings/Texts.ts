    ...
    declare namespace Db {
        ...
        namespace Administration {
            ...
            namespace Barrios {
                ...
                export const VerUserEnReservas: string;
            }
            ...
            namespace Notes {
                ...
                export const CreateUserUsername: string;
                export const DestinationUserId: string;
                export const DestinationUserUsername: string;
                export const Id: string;
                export const Message: string;
                export const ShowUser: string;
                export const UpdateDate: string;
                export const UpdatetionUserId: string;
                export const UpdatetionUserUsername: string;
            }
        ...
        namespace Default {
            ...
            namespace Reservas {
                export const BarrioId: string;
                export const Cant_Reservas: string;
                export const Confirmada: string;
                export const DateInsert: string;
                export const DateUpdate: string;
                ...
                export const Vecinos: string;
            }

            namespace ReservasRecurrentes {
                export const Dias: string;
                export const Domingo: string;
                export const Duracion: string;
                export const Feriados: string;
                export const Id: string;
                export const Inicio: string;
                export const Jueves: string;
                export const Lunes: string;
                export const Martes: string;
                export const Miercoles: string;
                export const Observaciones: string;
                export const ResourceId: string;
                export const Sabado: string;
                export const Viernes: string;
            }

            namespace ReservasRecursos {
                export const AmountForDays: string;
                export const AmountToReserve: string;
                export const Apertura: string;
                export const AppHoldId: string;
                export const BarrioId: string;
                export const BookingRecurringList: string;
                export const Cierre: string;
                export const ClientIdList: string;
                export const Description: string;
                export const Desde: string;
                export const Dias: string;
                export const Domingo: string;
                export const Emails: string;
                export const Feriados: string;
                export const Hasta: string;
                export const Id: string;
                export const Jueves: string;
                export const LimitHour: string;
                export const Lunes: string;
                export const MailBody: string;
                export const Martes: string;
                export const Miercoles: string;
                export const NeedComment: string;
                export const NeigborhoodList: string;
                export const Nombre: string;
                export const Regulation: string;
