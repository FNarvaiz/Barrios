    ...
    declare namespace Db {
        ...
        namespace Contenidos {
            ...
            namespace Avisos {
                ...
                export const IdCategoriaNombre: string;
            ...
            namespace ComisionesIntegrantes {
                ...
                export const IdComisionNombre: string;
                export const Nombre: string;
                export const UserInsert: string;
                export const UserInsertUsername: string;
                export const UserUpdate: string;
            ...
            namespace LineaTiempo {
                export const Anio: string;
                export const Aprobado: string;
                export const ArchivoBinarydata: string;
                export const ArchivoContenttype: string;
                export const ArchivoFilename: string;
                export const ArchivoFilesize: string;
        ...
        namespace Default {
            ...
            namespace Reservas {
                ...
                export const IdRecursoApertura: string;
                export const IdRecursoCierre: string;
                export const IdRecursoNombre: string;
                export const IdRecursoResolucion: string;
                export const IdResultado: string;
                export const IdTipo: string;
                export const IdVecino: string;
                export const IdVecino2: string;
                export const IdVecinoDisplayName: string;
                export const IdVecinoEmail: string;
                export const IdVecinoInsertDate: string;
                export const IdVecinoInsertUserId: string;
                export const IdVecinoIsActive: string;
                export const IdVecinoLastDirectoryUpdate: string;
                export const IdVecinoLatestAccess: string;
                export const IdVecinoNote: string;
                export const IdVecinoPasswordHash: string;
                export const IdVecinoPasswordSalt: string;
                export const IdVecinoPhones: string;
                export const IdVecinoSource: string;
                export const IdVecinoUnidad: string;
                export const IdVecinoUnidadExtra: string;
                export const IdVecinoUpdateDate: string;
                export const IdVecinoUpdateUserId: string;
                export const IdVecinoUserImage: string;
